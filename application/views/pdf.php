...
$this->fpdf->Cell(5 , 0.7, $data->WILAYAH , 1, 'LR', 'L');
$this->fpdf->Cell(5 , 0.7, $data->SUHU , 1, 'LR', 'L');
$this->fpdf->Cell(10 , 0.7, $data->CURAH_HUJAN , 1, 'LR', 'L');
$this->fpdf->Cell(3 , 0.7, $data->KELEMBABAN , 1, 'LR', 'L');
$this->fpdf->Cell(3 , 0.7, $data->DATE_TIME , 1, 'LR', 'L');
}
